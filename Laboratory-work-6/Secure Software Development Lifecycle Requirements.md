...
### Загальні Наслідки
| Обсяг | Вплив | Ймовірність |
|:-----:|:-----:|:-----------:|
| Інший | Технічний вплив: Залежить від Контексту; Прихованої Активності; Зменшення Надійності; Погіршення Якості; Зменшення Можливості Обслуговування. Без методу перевірки неможливо бути впевненим, що все працює, як очікувалося. | |

## CWE-637: Надмірна Складність в Механізмі Захисту (Не Використовується 'Економія Механізму')

### Опис
Продукт використовує більш складний механізм, ніж необхідно, що може призвести до вразливостей, коли механізм не розуміється, не моделюється, не конфігурується, не впроваджується або не використовується правильно.

### Розширений Опис
Механізми безпеки повинні бути якомога простішими. Складні механізми безпеки можуть спричинити часткові реалізації та проблеми з сумісністю, що призводять до невідповідності в припущеннях та реалізованій безпеці. Вивідним з цього принципу є те, що специфікації даних також повинні бути якомога простішими, оскільки складні специфікації даних призводять до складного коду перевірки. Складні завдання та системи також можуть потребувати складних перевірок безпеки, тому прості системи слід віддавати перевагу.
